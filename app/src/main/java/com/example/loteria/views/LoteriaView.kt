...
fun LoteriaView(viewModel: LoteriaViewModel){
    ...
    Column ( // Columna centrada horizontal y verticalmente.
        ...
        }else{ // Si la lista está vacía, le mandamos valores.
...
fun LotteryNumbers(numbers: List<Int>){
    LazyRow ( //Lazy row con cajas de texto (Box).
        ...
        items(numbers) { number->
            Box( // Se crean 6 cajas, pues se crean dependiendo de la generación en LoteriaViewModel.
